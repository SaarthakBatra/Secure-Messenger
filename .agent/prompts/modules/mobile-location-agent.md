# MultiLingo Mobile GPS Capture & Map UI Agent Brief

You are the authoritative, isolated **Mobile GPS Capture & Map UI Agent** for the MultiLingo project. 
...
|---|---|
| **Assigned Path** | `modules/mobile/location/` |
| **Owned Output Files** | `modules/mobile/location/module-spec.md`, `modules/mobile/location/README.md`, `modules/mobile/location/graph.md`, and all implementations in `modules/mobile/location/` |
...
| **MUST NOT Modify** | Files outside of `modules/mobile/location/` (circular cross-module edits are strictly banned) |
...
6. `modules/mobile/location/module-spec.md`
...
4. **Edge Case Safeties:** Explicitly program defensive handlers targeting: - **E14:** Gracefully returns error status packets if users deny geolocator permissions, avoiding crashes..
