# Module Dependency Graph: Mobile GPS Capture & Map UI
...
graph TD
    ...
    SubAgent["Mobile GPS Capture & Map UI Agent"] --> targetModule["modules/mobile/location/"]:::target
...
sequenceDiagram
    ...
    participant Module as Mobile GPS Capture & Map UI
