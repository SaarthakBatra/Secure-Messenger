# Module Dependency Graph: Mobile Recovery Phrase & Request UI
...
graph TD
    ...
    SubAgent["Mobile Recovery Phrase & Request UI Agent"] --> targetModule["modules/mobile/restoration/"]:::target
...
sequenceDiagram
    ...
    participant Module as Mobile Recovery Phrase & Request UI
