# Module Dependency Graph: Mobile Notebook UI & Editor
...
graph TD
    ...
    SubAgent["Mobile Notebook UI & Editor Agent"] --> targetModule["modules/mobile/notes/"]:::target
...
sequenceDiagram
    ...
    participant Module as Mobile Notebook UI & Editor
