# Module Dependency Graph: Backend Disguised Push Engine
...
graph TD
    ...
    SubAgent["Backend Disguised Push Engine Agent"] --> targetModule["modules/backend/notifications/"]:::target
...
sequenceDiagram
    ...
    participant Module as Backend Disguised Push Engine
