# Module Dependency Graph: Backend Shared Notes Server
...
graph TD
    ...
    SubAgent["Backend Shared Notes Server Agent"] --> targetModule["modules/backend/notes/"]:::target
...
sequenceDiagram
    ...
    participant Module as Backend Shared Notes Server
